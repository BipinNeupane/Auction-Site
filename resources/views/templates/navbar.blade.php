  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
      <ul class="navbar-nav mb-2 mb-lg-0">
        ...
        @if(Auth::check())
        <li class="nav-item">
          <a class="nav-link" href="{{route('to-dashboard')}}"><button class="btn btn-sm btn-dark">Dashboard</button></a>
        </li>
      
      @endif
      <form class="d-flex" action="{{ route('search-products') }}" method="POST" role="search">
        @csrf
        <input class="form-control me-2" name="query" type="search" placeholder="Search" aria-label="Search" data-form-type="" required>
        <button class="btn btn-outline-primary" type="submit" data-dashlane-rid="7aae0f4899be1c1e" data-dashlane-label="true">Search</button>
      </form>
